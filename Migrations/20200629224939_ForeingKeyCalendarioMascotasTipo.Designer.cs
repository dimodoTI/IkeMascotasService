...
namespace MascotasApi.Migrations
{
    ...
    [Migration("20200629224939_ForeingKeyCalendarioMascotasTipo")]
    partial class ForeingKeyCalendarioMascotasTipo
    {
            ...
            modelBuilder.Entity("MascotasApi.Models.Calendario", b =>
                {
                    b.HasOne("MascotasApi.Models.MascotasTipo", "MascotasTipo")
                        .WithOne("calendario")
                        .HasForeignKey("MascotasApi.Models.Calendario", "MascotasTipoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
